...
# Kakarot SSJ artifacts for precompiles likes
...
# This action fetches the latest Kakarot SSJ (Cairo compiler version >=2) artifacts jn Kakaroot
...
run-katana:
	katana --validate-max-steps 167772136 --invoke-max-steps 16777216 --eth-gas-price 0 --strk-gas-price 0 --disable-fee
